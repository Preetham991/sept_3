# Save the Python script to email_confidence.py
python_script_content = '''import numpy as np
import pandas as pd
...
with open('email_confidence.py', 'w') as f:
    f.write(python_script_content)

print("Python script saved as email_confidence.py")